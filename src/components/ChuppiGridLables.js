...
class chuppiGridLables extends Component {
  constructor(props) {
    super(props);
    this.state = { input: "" };
  ...
  getImage(label) {
    ...
    const url = [config.APIURL,"showSavings/1/99999999"].join("/");
    console.log(url);
    axios
  ...
  getDataCustom() {
    ...
    const url = [config.APIURL, "prodlabel"].join("/");
    console.log(url);
    const pattern = /^[A-Z].*/;
    var { start, end } = this.state.pagination;
    axios
    ...
    return (
      <div className="chuppi">
        ...
        <div className="row1">
          ...
          <div className="chuppiGridLabel" style={{ minHeight: "84vh" }}>
            {this.state.data
              ? this.state.data.map((i, j) => (
                  <div key={j} className="chuppiGridPodLabel">
                    <div className="chuppiGridItemLabel">
                      <Link
                        onMouseOver={e =>
                          this.setState({ currentItem: e.target.text, showButton:1 })
                        }
                      ...
                      {this.state.currentItem ? (
                        (this.state.currentItem === i && this.state.showButton) ? (
...
export default chuppiGridLables;
